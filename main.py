...
print("Импортированный ffmpeg из:", getattr(ffmpeg, '__file__', 'No __file__ attribute'))
print("Атрибут input:", hasattr(ffmpeg, "input"))
print("Список атрибутов:", dir(ffmpeg))
